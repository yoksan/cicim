...
$results = array();
$ipList = array("37.59.222.48","37.59.222.49","37.59.222.50","46.105.73.52","46.105.77.96","87.98.243.201","87.98.244.35","87.98.253.121","87.98.253.201","94.23.88.233","91.121.216.78","94.23.144.93","94.23.169.63","178.32.58.4","178.32.58.220","188.165.18.122","188.165.209.107");
$ipRander = (count($ipList)-1);
$rader = rand(0,$ipRander);
...
$mailList = array();
$mailList = $_GET["email"];
$codeden = generateCode(10,1);
//$mailList[$codeden.'@windowslive.com'] = $codeden.'@windowslive.com';
